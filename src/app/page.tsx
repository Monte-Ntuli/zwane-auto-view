...
const STATS = [
  ...
  { value: "ZAR", label: "Transparent Pricing" },
  { value: "5★", label: "Customer Trust" },
];
    ...
    <div>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          ...
          {/* Search Card */}
          <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5 md:p-6 shadow-2xl">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {displayVehicles.length > 0 ? (
          ...
          <div className="text-center py-20 text-slate-400">
            ...
            <p className="text-lg font-semibold text-slate-500">No vehicles yet</p>
            <p className="text-sm mt-1">Check back soon — new listings are added regularly.</p>
          </div>
        )}
        ...
        {displayVehicles.length > 0 && (
          <div className="text-center mt-10">
            <Link
              href="/vehicles"
              className="inline-flex items-center gap-2 border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold px-8 py-3 rounded-xl transition-colors text-sm"
            >
              Browse All Vehicles
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
      ...
      <section className="bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <h2 className="text-2xl font-extrabold text-slate-900 text-center mb-10">Why Buy From Us?</h2>
